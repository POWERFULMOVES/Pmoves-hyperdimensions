# PMOVES-Agent-Zero — Hyperdimensions Integration Dossier

_Last updated: 2026-02-16_
_Branch variant: `PMOVES.AI-Edition-Hardened-A0`_
_Topology file: `saves/PMOVES-Agent-Zero_topology.json`_
...
| **Evolution Stage** | mega — Mega Evolution (full-stack, spans all planes) |
| **Ports** | 8080 (Agent Zero) |

## 2. Purpose in PMOVES.AI

This dossier documents the hyperdimensional display configuration for `PMOVES-Agent-Zero`.
...
|-------|-------|------|------|-------|-------------|
| Agent Zero | standard | agent/api | 8080 | mega | Primary L1 orchestrator with embedded agent runtime and MCP API |
...
- **Submodule Docs**: [`PMOVES-Agent-Zero/README.md`](../../PMOVES-Agent-Zero/README.md)
