# PMOVES-MAI-UI — Hyperdimensions Integration Dossier

_Last updated: 2026-02-16_
_Branch variant: `PMOVES.AI-Edition-Hardened-MAI`_
_Topology file: `saves/PMOVES-MAI-UI_topology.json`_
...
This dossier documents the hyperdimensional display configuration for `PMOVES-MAI-UI`.
...
|-------|-------|------|------|-------|-------------|
| MAI-UI | standard | ui/agent | N/A | base | Main user interface |
...
- **Submodule Docs**: [`PMOVES-MAI-UI/README.md`](../../PMOVES-MAI-UI/README.md)
